...
# Sol4'ten Mi2'ye kadar olan notalar (28 nota)
notes = [
    'Mi2', 'Fa2', 'Fa#2', 'Sol2', 'Sol#2', 'La2', 'La#2', 'Si2',
    'Do3', 'Do#3', 'Re3', 'Re#3', 'Mi3', 'Fa3', 'Fa#3', 'Sol3',
    'Sol#3', 'La3', 'La#3', 'Si3', 'Do4', 'Do#4', 'Re4', 'Re#4',
    'Mi4', 'Fa4', 'Fa#4', 'Sol4'
]

# Dosya yolu ve dosyaların bulunduğu dizin
directory = 'elektrobas1lik'  # Dosyaların bulunduğu dizin. Gerekirse burayı güncelleyin.

# Dosyaları listele ve sırasıyla yeniden adlandır
file_list = [f for f in os.listdir(directory) if f.endswith(".wav")]
file_list.sort(key=lambda x: int(x.split('_')[1].split('.')[0]))  # Örn: note_1.wav, note_2.wav gibi dosyalar sıralanır.
