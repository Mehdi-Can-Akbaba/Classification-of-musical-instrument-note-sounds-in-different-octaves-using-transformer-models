...
# Sol3'ten Mi7'ye kadar olan notalar (keman için)
notes = [
    'Sol3', 'Sol#3', 'La3', 'La#3', 'Si3', 'Do4', 'Do#4', 'Re4', 'Re#4', 'Mi4',
    'Fa4', 'Fa#4', 'Sol4', 'Sol#4', 'La4', 'La#4', 'Si4', 'Do5', 'Do#5', 'Re5',
    'Re#5', 'Mi5', 'Fa5', 'Fa#5', 'Sol5', 'Sol#5', 'La5', 'La#5', 'Si5', 'Do6',
    'Do#6', 'Re6', 'Re#6', 'Mi6', 'Fa6', 'Fa#6', 'Sol6', 'Sol#6', 'La6', 'La#6',
    'Si6', 'Do7', 'Do#7', 'Re7', 'Re#7', 'Mi7'
]

# Dosya yolu ve dosyaların bulunduğu dizin
directory = 'k1lik'  # Dosyaların bulunduğu dizin. Gerekirse burayı güncelleyin.
