...
# Notalar listesi (Frekans değerleri silindi)
notes = [
    ('Mi2'), ('Fa2'), ('Fa#2'), ('Sol2'), ('Sol#2'),
    ('La2'), ('La#2'), ('Si2'), ('Do3'), ('Do#3'),
    ('Re3'), ('Re#3'), ('Mi3'), ('Fa3'), ('Fa#3'),
...
output_folder = 'akorsuzeg4lük'  # İşlenmiş ses dosyalarının kaydedileceği klasör
...
def process_files():
    try:
        ...
        for file in files:
            ...
            pitch_up_change = random.randint(-10, -8)  # Tiz bozuk frekans (-5 ile -10 arasında)
            pitch_down_change = random.randint(8, 10)  # Pes bozuk frekans (+5 ile +10 arasında)
