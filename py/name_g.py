...
# Mi2'den Fa#5'e kadar olan notalar (gitar için)
notes = [
    ...
    'La#4', 'Si4', 'Do5', 'Do#5', 'Re5', 'Re#5', 'Mi5', 'Fa5', 'Fa#5'
]

# Dosya yolu ve dosyaların bulunduğu dizin
directory = 'eg4lük'  # Dosyaların bulunduğu dizin. Gerekirse burayı güncelleyin.
